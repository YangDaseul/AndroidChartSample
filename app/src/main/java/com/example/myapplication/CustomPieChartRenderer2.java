...
class CustomPieChartRenderer2 extends PieChartRenderer {

    private Boolean mHasLabelData = false;
    private Boolean mHasValueData = false;
    private Canvas mEntryLabelCanvas = null;
    private Canvas mValueCanvas = null;
    private String mEntryLabel = "";
    private String mValueText = "";
    private float mEntryLabelX = 0f;
    private float mEntryLabelY = 0f;
    private float mValueX = 0f;
    private float mValueY = 0f;
    private int mValueColor = 0;

    private Paint mEntryLabelsPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

    public CustomPieChartRenderer2(PieChart chart, ChartAnimator animator, ViewPortHandler viewPortHandler) {
    ...
    private void checkToDrawLabelValue(){
    ...
    private void drawEntryLabelData(Canvas c, String label, float x, float y) {
        Paint mEntryLabelsPaint = getPaintEntryLabels();
...
//        mEntryLabelsPaint.setTextAlign(Paint.Align.CENTER);
    ...
    private void drawValueData(Canvas c, String valueText, float x, float y, int color){
